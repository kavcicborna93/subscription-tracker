...
// callback function which autocalculates renewal date if missing

// jdoc cause this refers in different context //
...
subscriptionSchema.pre('save', function (next) {
    ...
    // Call next to make it proceed with creation of document in the database //
    next();
})
